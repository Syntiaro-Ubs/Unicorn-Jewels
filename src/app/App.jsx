...
export default function App() {
  ...
  if (currentPage === 'collection' && activeCollection) {
    return <>
        ...
        <CollectionPage collectionName={activeCollection} onBack={() => setCurrentPage('home')} onCollectionChange={name => {
        setActiveCollection(name);
        window.scrollTo({
          top: 0,
          behavior: 'instant'
        });
      }} wishlist={wishlist} toggleWishlist={toggleWishlist} addToCart={addToCart} addedIds={addedIds} onProductClick={p => openProductPage(p, 'collection')} />
  ...
  if (currentPage === 'category' && activeCategory) {
    return <>
        ...
        <CategoryPage category={activeCategory} onCategoryChange={setActiveCategory} onBack={() => setCurrentPage('home')} wishlist={wishlist} toggleWishlist={toggleWishlist} addToCart={addToCart} addedIds={addedIds} onProductClick={p => openProductPage(p, 'category')} />
      ...
      <section className="relative min-h-[calc(100vh-64px)] sm:min-h-[calc(100vh-72px)] md:min-h-[calc(100vh-80px)] flex flex-col lg:flex-row bg-black overflow-hidden border-b border-gray-900 w-full">
        ...
        <div className="w-full lg:w-[40%] flex flex-col justify-center px-6 sm:px-8 md:px-12 lg:px-20 py-12 sm:py-16 md:py-20 lg:py-0 z-10 bg-black order-2 lg:order-1 max-w-full">
          ...
          delay: 0.2
            ...
            letterSpacing: '-0.02em'
              ...
              Unicorn<br />
              <span className="italic text-[#C0C0C0]">Jewels</span>
            </h1>
        ...
        <div className="w-full lg:w-[60%] h-[50vh] sm:h-[60vh] lg:h-auto lg:min-h-[calc(100vh-80px)] relative overflow-hidden group order-1 lg:order-2 max-w-full">
          ...
          ease: "easeOut"
            ...
            <ImageWithFallback src={heroImage} alt="Luxury Jewelry" className="w-full h-full object-cover object-center transform group-hover:scale-105 transition-transform duration-[2000ms] ease-out" />
